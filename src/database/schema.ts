  ...
  tables: [
    ...
    tableSchema({
      ...
      columns: [
        ...
        { name: 'parameters', type: 'string', isOptional: true }, // JSON string
        { name: 'server_id', type: 'string', isOptional: true },
        { name: 'last_sync', type: 'number', isOptional: true },
        { name: 'created_at', type: 'number' },
        { name: 'updated_at', type: 'number' },
    ...
    tableSchema({
      name: 'tax_rules',
      columns: [
        { name: 'tax_form_id', type: 'string' },
        { name: 'name', type: 'string' },
        { name: 'rule_type', type: 'string' },
        { name: 'conditions', type: 'string', isOptional: true }, // JSON string
        { name: 'calculation_method', type: 'string' },
        { name: 'value', type: 'number' },
        { name: 'min_base', type: 'number', isOptional: true },
        { name: 'max_base', type: 'number', isOptional: true },
